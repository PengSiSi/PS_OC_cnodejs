...
#define K_TAB_BAR_H ([[UIApplication sharedApplication] statusBarFrame].size.height > 20 ? 83 : 49)
#define K_STATUS_BAR_AND_NAVI_BAR_H (kStatusBarHeight + kNavBarHeight)
