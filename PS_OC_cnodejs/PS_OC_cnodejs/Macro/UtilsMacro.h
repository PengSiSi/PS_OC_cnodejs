...
// 消息
// @"MessageDataBase"
#define KMESSAGEDATABASENAME [NSString stringWithFormat:@"%@%@.realm", KUSERDEFAULT_OBJ4KEY(KUSERNAME), @"MessageDataBase"]

// 作业考试列表
#define KHOMEWORKDATABASENAME @"HomeWorkDataBaseName"

// Realm数据库版本
#define KDOWNLOADDATABASENAMEVERSION 2.0
// 微课程Id
#define KMicrolectureCourseResourceId @"kMicrolectureCourseResourceId"
// 资源Id
#define KResourceId @"kResourceId"
...
#define KCOMMITSUCCESS @"提交成功"
#define KCOMMITERROR @"提交失败"
...
#define kReloadListDataNotification @"kReloadListDataNotification"
